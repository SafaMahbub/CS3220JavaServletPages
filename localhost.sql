...
--
-- Host: localhost
-- Generation Time: Dec 04, 2016 at 02:15 AM
...
(13, 'Percy Jackson ', 20, 'Demigod', 2),
(14, 'Harry Potter', 20, 'Wizard', 20);
...
INSERT INTO `order_histories` (`order_id`, `product_name`, `quantity`, `price`) VALUES
('14', 'Harry Potter', 1, 20),
('14', 'Percy Jackson ', 2, 20),
('15', 'Harry Potter', 2, 20),
('15', 'Percy Jackson ', 1, 20),
('16', 'Harry Potter', 4, 20);
...
--
-- Dumping data for table `total_costs`
--

INSERT INTO `total_costs` (`order_id`, `total`) VALUES
(14, 60),
(15, 60),
(16, 80);
